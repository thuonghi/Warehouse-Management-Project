...
public class ManageWorkAreaPage_Search extends BaseSetup {
    ...
    private com.managesys.pages.ManageWorkAreaPage_Search manageWorkAreaPage_search;
    ...
    @Test(priority = 3)
    public void searchWorkArea(){
        validataHelper = new ValidataHelper(driver);
        manageWorkAreaPage_search = manageWorkAreaPage.findFunction();
        manageWorkAreaPage_search.CheckSearchByValue();
        manageWorkAreaPage_search.checkSearchTableByColumn(3, "CNTT");
    }
    @AfterClass
